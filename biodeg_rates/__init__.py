...
Three independent estimators producing FOUR estimands, each measuring a DIFFERENT
quantity by a DIFFERENT method on a DIFFERENT data geometry:
  ...
  module 3  method3_spline        — TWO estimands off one spatio-temporal P-spline surface:
                                     k_centre (-df/dt at the plume centre) and k_mass
                                     (-d ln M(t)/dt over the data-supported footprint)
